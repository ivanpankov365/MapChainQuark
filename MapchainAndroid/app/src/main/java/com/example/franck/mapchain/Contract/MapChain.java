package com.example.franck.mapchain.Contract;
...
public class MapChain extends Contract {
    ...
    public RemoteCall<TransactionReceipt> AddTask(String _task) {
        final Function function = new Function(
                "AddTask",
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(_task)),
    ...
    public static RemoteCall<MapChain> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _price, String _task1, String _task2, String _task3) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_price),
                new org.web3j.abi.datatypes.Utf8String(_task1),
                new org.web3j.abi.datatypes.Utf8String(_task2),
                new org.web3j.abi.datatypes.Utf8String(_task3)));
